...
all_input_list = sorted(glob.glob('D:\study\_data\\bokckoy\\train_input/*.csv'))
all_target_list = sorted(glob.glob('D:\study\_data\\bokckoy\\train_target/*.csv'))
...
class BaseModel(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(input_size=37, hidden_size=180, batch_first=True, bidirectional=False)
...
test_input_list = sorted(glob.glob('D:\study\_data\\bokckoy\\test_input/*.csv'))
test_target_list = sorted(glob.glob('D:\study\_data\\bokckoy\\test_target/*.csv'))
...
os.chdir("D:\study\_data\\bokckoy\\test_target")
