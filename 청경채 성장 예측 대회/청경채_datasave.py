...
np.save('D:\study\_data\\bokckoy\\train_input\.npy', train_data)
np.save('D:\study\_data\\bokckoy\\train_target\.npy', label_data)
np.save('D:\study_data\_save\_npy/val_data1.npy', val_data)
np.save('D:\study_data\_save\_npy/val_target1.npy', val_target)
np.save('D:\study\_data\\bokckoy\\test_input\.npy', test_input)
np.save('D:\study\_data\\bokckoy\\test_target\.npy', test_target)