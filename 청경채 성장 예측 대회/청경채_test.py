...
for i in range(6):
    thislen=0
    thisfile = 'D:\study\_data\\bokckoy\\test_target'+'TEST_0'+str(i+1)+'.csv'
...
os.chdir('D:\study\_data\\bokckoy/test_target')
with zipfile.ZipFile("submission220918.zip", 'w') as my_zip:
    for i in filelist:
        my_zip.write(i)
    my_zip.close()
